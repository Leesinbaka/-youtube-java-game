...
//       for(int y =0;y<32;y++){
//           for(int x = 0 ;x<32 ; x++){
//           screen.render(x<<3,y<<3,0,clo.get(005,505,055,550),true,false);//make them to W R G B //0 first box 
//           //clo.get 會取得一個 long 數值
//           }
//       }//level map
        
        Font.render("P", screen, x, y, clo.get(000, -1, -1, 555));
        String msg = "haha:3";
        Font.render(msg,screen,screen.xOffset + screen.width/2-((msg.length()*8)/2),screen.yOffset+screen.height/2,clo.get(000,-1,-1,555));
